...
export const TABLE_TRANSACTION_ACCOUNTS = 'transactionAccounts';
...
export function up(knex) {
  return knex.schema.createTable(TABLE_TRANSACTION_ACCOUNTS, (t) => {
...
export function down(knex) {
  return knex.schema.dropTableIfExists(TABLE_TRANSACTION_ACCOUNTS);
}
